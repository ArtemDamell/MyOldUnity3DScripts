...
public class MapGen : MonoBehaviour
{
    ...
    /// <summary>
    /// Builds a texture with a given size and applies it to the MeshRenderer.
    /// </summary>
    /// <returns>
    /// A Texture2D object with the given size and color.
    /// </returns>
    void BuildTexture()
    {
        int texWidth = size_x;
    ...
    /// <summary>
    /// Builds a mesh with the given size_x and size_z parameters.
    /// </summary>
